...
public class NumeroLinea extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
    ...
    private static Color COLOR_NUMBERS = new Color(79, 137, 255);
    private Color colorNumberSelect = new Color(0, 102, 153);
    ...
    public NumeroLinea(JTextComponent component, int minimumDisplayDigits) {
        ...
        initComponent();
        // Font fontSelect = new Font(component.getFont().getFontName(), Font.BOLD, component.getFont().getSize());
        setFont(component.getFont());

        setBorderGap(5);
        setCurrentLineForeground(colorNumberSelect);
        ...
        while (rowStartOffset <= endOffset) {
            try {
                if (isCurrentLine(rowStartOffset)) {
                    g.setColor(getCurrentLineForeground()); // Se obtiene el color que se instanció en el constructor
                } else {
